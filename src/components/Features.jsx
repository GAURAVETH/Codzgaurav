...
const BentoTilt = ({ children, className = "" }) => {
  ...
  const handleMouseMove = (e) => {
    ...
    const newTransform = `perspective(700px) rotateX(${tiltY}deg) rotateY(${tiltX}deg) scale(0.99)`;
    setTransformStyle(newTransform);
  };

  const handleMouseLeave = () => {
    setTransformStyle(""); // Reset transform on mouse leave
  };
    ...
    <div className="container mx-auto px-3 md:px-10">
      <div className="px-5 py-32">
        ...
        <p className="max-w-md font-circular-web text-lg text-blue-50 opacity-50">
          Lorem ipsum, dolor sit amet consectetur adipisicing elit. Sunt, deserunt ea quibusdam repellat est praesentium?
        </p>
      </div>
      ...
      <div className="grid h-[135vh] grid-cols-2 grid-rows-3 gap-7">
        ...
        <BentoTilt className="bento-title_1 row-span-1 ms-32 md:col-span-1 md:ms-0">
          <BentoCard
            ...
            title={<>n<b>e</b>xus</>}
            description="Lorem, ipsum dolor sit amet consectetur adipisicing elit. Recusandae id necessitatibus obcaecati maxime dicta ipsum."
          />
        </BentoTilt>
